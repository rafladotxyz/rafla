    ...
    <div className="fixed flex max-w-85 max-h-112.25 rounded-3xl bg-[#141414] border-[1.5px] border-[#282828] py-6 px-4 ">
      <div className="flex flex-col items-center max-w-77 max-h-66.25 gap-6">
        ...
        <div className="flex-col items-center justify-center max-w-34 max-h-22 gap-3">
          ...
          <div className="max-w-34 max-h-7">
        ...
        {/** Content */}
        <div className="max-w-77 max-h-38.25 gap-4">
          <p className="max-w-77 max-h-10.5 text-[14px] text-[#CBCBCB] ">
            This is a chance based game .You may lose your entry.
          </p>
          <p className="max-w-77 max-h-5.25 text-[14px] text-[#CBCBCB] ">
        ...
        {/** Confirm  */}
        <div className="flex max-w-70 max-h-15 gap-2">
          <div className="flex max-w-5 max-h-7 py-1 px-1 gap-1">
            <div className="w-5 h-5"></div>
          </div>
          <p className="max-w-70 max-h-15 text-[#737373] text-[13px]">
        ...
        <button
          onClick={toggle}
          className="flex items-center justify-center max-w-77 max-h-11 rounded-xl text- py-3 px-3 gap-1 bg-[#FFFFFF] "
        >
          <p className="max-w-15.5 max-h-5 text-[14px] text-center text-[#0A0A0A]">{`Let's Play`}</p>
        </button>
      </div>
    </div>
  );
